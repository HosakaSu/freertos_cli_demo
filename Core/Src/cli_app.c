...
//*****************************************************************************
BaseType_t cmd_clearScreen(int8_t *pcWriteBuffer, size_t xWriteBufferLen,
...
//*****************************************************************************
BaseType_t cmd_toggle_led(int8_t *pcWriteBuffer, size_t xWriteBufferLen,
                          const int8_t *pcCommandString) {
...
//*****************************************************************************
BaseType_t cmd_add(int8_t *pcWriteBuffer, size_t xWriteBufferLen,
                   const int8_t *pcCommandString) {
...
const CLI_Command_Definition_t xCommandList[] = {
    {
        .pcCommand = "clear", /* The command string to type. */
        .pcHelpString = "clear:\r\n Clears screen\r\n\r\n",
